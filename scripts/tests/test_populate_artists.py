...
class TestArtistList(unittest.TestCase):
    ...
    def test_artists_list_structure(self):
        ...
        for artist in artists:
            ...
            self.assertTrue(artist.instagram_link.startswith("https://www.instagram.com/"))
...
def test_main_execution(mock_instagram_api, mock_artist_manager):
    ...
    mock_instagram_api.fetch_profile_picture_hd.return_value = "https://example.com/pic.jpg"

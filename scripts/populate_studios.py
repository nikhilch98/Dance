...
class StudioManager:
    ...
    def update_studio(self, studio: Studio) -> None:
        ...
        self.collection.update_one(
            {"studio_id": studio.studio_id}, {"$set": data}, upsert=True
        )
    ...
    def get_existing_image(self, studio_id: str) -> Optional[str]:
        ...
        """
        result = self.collection.find_one({"studio_id": studio_id}, {"image_url": 1})
...
def get_studios_list() -> List[Studio]:
    ...
    return [
        ...
        Studio("theroyaldancespace", "The Royals", "theroyaldancespace"),
        Studio("beinrtribe", "RTribe", "beinrtribe"),
        Studio("goodmove_studios", "Good Move Studios", "goodmove_studios"),
    ]

...
class Settings(BaseSettings):
    ...
    reward_cashback_percentage: float = 10.0  # 15% cashback on workshop bookings
    reward_redemption_cap_percentage: float = 10.0  # Max 10% of workshop cost can be redeemed
    reward_redemption_cap_per_workshop: float = 50.0  # Max 500 rupees redeemable per workshop
